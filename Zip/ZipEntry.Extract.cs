...
namespace IonicCustomMod.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        /// </overloads>
        ///
        /// <seealso cref="IonicCustomMod.Zip.ZipEntry.ExtractExistingFile"/>
        ...
        {
            InternalExtract(null, stream, 0, 0, 0);
        }
        ...
        ///
        /// <seealso cref="IonicCustomMod.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="IonicCustomMod.Zip.ZipEntry.Extract(string, ExtractExistingFileAction)"/>
        ///
        /// <example>
        ...
        {
            InternalExtract(baseDirectory, null, 0, 0, 0);
        }
        ...
        ///
        /// <seealso cref="IonicCustomMod.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="IonicCustomMod.Zip.ZipEntry.ExtractWithPassword(ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        ///
        /// <para>
        ...
        ///   cref="IonicCustomMod.Zip.ZipEntry.ExtractExistingFile"/>property, or call
        ///   <see
        ...
        public void ExtractWithPassword(UInt32 key1, UInt32 key2, UInt32 key3)
        {
        ...
        ///
        /// <seealso cref="IonicCustomMod.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="IonicCustomMod.Zip.ZipEntry.ExtractWithPassword(string, ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        /// <para>
        ///   Existing entries in the filesystem will not be overwritten. If you
        ...
        /// <param name="baseDirectory">The pathname of the base directory.</param>
        /// <param name="password">The Password to use for decrypting the entry.</param>
        public void ExtractWithPassword(string baseDirectory, UInt32 key1, UInt32 key2, UInt32 key3)
        {
        ...
        /// </param>
        public void ExtractWithPassword(Stream stream, UInt32 key1, UInt32 key2, UInt32 key3)
        {
            InternalExtract(null, stream, key1, key2, key3);
        }
        ...
        ///   cref="IonicCustomMod.Crc.CrcCalculatorStream"/>.  Use it as you would any
        ...
        ///   cref="IonicCustomMod.Crc.CrcCalculatorStream.Crc"/> property on the
        ...
        /// </code>
        /// </example>
        /// <seealso cref="IonicCustomMod.Zip.ZipEntry.Extract(System.IO.Stream)"/>
        /// <returns>The Stream for reading.</returns>
        public IonicCustomMod.Crc.CrcCalculatorStream OpenReader()
        {
            // workitem 10923
            ...
            if(this._Key1 == 0 && this._Key2 == 0 && this._Key3 == 0)
                return InternalOpenReader(this._container._Key1, this._container._Key2, this._container._Key3);
            return InternalOpenReader(this._Key1, this._Key2, this._Key3);
        }
        ...
        /// <param name="password">The password to use for decrypting the entry.</param>
        /// <returns>The Stream for reading.</returns>
        public IonicCustomMod.Crc.CrcCalculatorStream OpenReader(UInt32 key1, UInt32 key2, UInt32 key3)
        {
            // workitem 10923
            if (_container.ZipFile == null)
                throw new InvalidOperationException("Use OpenReader() only with ZipFile.");

            return InternalOpenReader(key1, key2, key3);
        }



        internal IonicCustomMod.Crc.CrcCalculatorStream InternalOpenReader(UInt32 key1, UInt32 key2, UInt32 key3)
        {
            ValidateCompression();
            ValidateEncryption();
            SetupCryptoForExtract(key1, key2, key3);
            ...
            // workitem 10178
            IonicCustomMod.Zip.SharedUtilities.Workaround_Ladybug318918(this.ArchiveStream);

            _inputDecryptorStream = GetExtractDecryptor(input);
            Stream input3 = GetExtractDecompressor(_inputDecryptorStream);

            return new IonicCustomMod.Crc.CrcCalculatorStream(input3, LeftToRead);
        }
        ...
        private void InternalExtract(string baseDir, Stream outstream, UInt32 key1, UInt32 key2, UInt32 key3)
        {
            // workitem 7958
            if (_container == null)
            ...
            try
            {
                ...
                if(key1 == 0 && key2 == 0 && key3 == 0)
                {
                    ...
                    if (key1 == 0 && key2 == 0 && key3 == 0)
                    {
                        key1 = this._container._Key1;
                        key2 = this._container._Key2;
                        key3 = this._container._Key3;
                    }
                }
                ...
                if(k1 == 0 && k2 == 0 && k3 == 0)
                {
                    ...
                    if (k1 == 0 && k2 == 0 && k3 == 0)
                    {
                        k1 = this._container._Key1;
                        k2 = this._container._Key2;
                        k3 = this._container._Key3;
                    }
                }
                if (_Encryption_FromZipFile != EncryptionAlgorithm.None)
                {
                    ...
                    SetupCryptoForExtract(k1, k2, k3);
                }
        ...
        private Int32 ExtractOne(Stream output)
        {
            ...
            try
            {
                ...
                // workitem 10178
                IonicCustomMod.Zip.SharedUtilities.Workaround_Ladybug318918(input);
                ...
                using (var s1 = new IonicCustomMod.Crc.CrcCalculatorStream(input3))
                {
                    while (LeftToRead > 0)
                    {
        ...
        internal Stream GetExtractDecompressor(Stream input2)
        {
            ...
            switch (_CompressionMethod_FromZipFile)
            {
                ...
                case (short)CompressionMethod.Deflate:
                    return new IonicCustomMod.Zlib.DeflateStream(input2, IonicCustomMod.Zlib.CompressionMode.Decompress, true);
#if BZIP
                case (short)CompressionMethod.BZip2:
                    return new IonicCustomMod.BZip2.BZip2InputStream(input2, true);
#endif
            }
        ...
        internal void _SetTimes(string fileOrDirectory, bool isFile)
        {
            ...
            try
            {
                ...
                {
                    // workitem 6191
                    DateTime AdjustedLastModified = IonicCustomMod.Zip.SharedUtilities.AdjustTime_Reverse(LastModified);
 ...
 Encryption != EncryptionAlgorithm.None)
        ...
        private void SetupCryptoForExtract(UInt32 key1, UInt32 key2, UInt32 key3)
        {
            ...
            if (_Encryption_FromZipFile == EncryptionAlgorithm.PkzipWeak)
            {
                ...
                // workitem 10178
                IonicCustomMod.Zip.SharedUtilities.Workaround_Ladybug318918(this.ArchiveStream);
                _zipCrypto_forExtract = ZipCrypto.ForRead(key1, key2, key3, this);
            }
        }
