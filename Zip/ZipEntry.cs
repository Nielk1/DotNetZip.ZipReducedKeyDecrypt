...
namespace IonicCustomMod.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        public ZipEntry()
        {
            ...
            _CompressionLevel = IonicCustomMod.Zlib.CompressionLevel.Default;
        ...
        public DateTime LastModified
        {
            ...
            set
            {
                _LastModified = (value.Kind == DateTimeKind.Unspecified)
                    ...
                    : value.ToLocalTime();
                _Mtime = IonicCustomMod.Zip.SharedUtilities.AdjustTime_Reverse(_LastModified).ToUniversalTime();
        ...
        /// <seealso cref="IonicCustomMod.Zip.ZipEntry.LastModified"/>
        ...
        public CompressionMethod CompressionMethod
        {
            ...
            set
            {
                ...
                if (_CompressionMethod == (Int16)IonicCustomMod.Zip.CompressionMethod.None)
                    _CompressionLevel = IonicCustomMod.Zlib.CompressionLevel.None;
                else if (CompressionLevel == IonicCustomMod.Zlib.CompressionLevel.None)
                    _CompressionLevel = IonicCustomMod.Zlib.CompressionLevel.Default;
        ...
        ///
        /// <seealso cref="CompressionMethod"/>
        public IonicCustomMod.Zlib.CompressionLevel CompressionLevel
        {
            get
            {
            ...
            set
            {
                ...
                if (value == IonicCustomMod.Zlib.CompressionLevel.Default &&
                    _CompressionMethod == (short)CompressionMethod.Deflate) return; // nothing to do
                _CompressionLevel = value;

                if (value == IonicCustomMod.Zlib.CompressionLevel.None &&
                    _CompressionMethod == (short)CompressionMethod.None)
                    return; // nothing more to do

                if (_CompressionLevel == IonicCustomMod.Zlib.CompressionLevel.None)
                    _CompressionMethod = (short) IonicCustomMod.Zip.CompressionMethod.None;
                else
                    _CompressionMethod = (short) IonicCustomMod.Zip.CompressionMethod.Deflate;
        ...
        /// </remarks>
        ///
        /// <seealso cref="IonicCustomMod.Zip.ZipEntry.UncompressedSize"/>
        ...
        /// </remarks>
        ///
        /// <seealso cref="IonicCustomMod.Zip.ZipEntry.CompressedSize"/>
        ...
        /// </exception>
        ///
        /// <seealso cref="IonicCustomMod.Zip.ZipEntry.Password">ZipEntry.Password</seealso>
        /// <seealso cref="IonicCustomMod.Zip.ZipFile.Encryption">ZipFile.Encryption</seealso>
        ...
        ///
        /// </remarks>
        /// <seealso cref="IonicCustomMod.Zip.ZipFile.ExtractExistingFile"/>
        ///
        /// <example>
        ...
        ///
        /// </remarks>
        /// <seealso cref="IonicCustomMod.Zip.ZipFile.ZipErrorAction"/>
        /// <seealso cref="IonicCustomMod.Zip.ZipFile.ZipError"/>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    AlternateEncoding = IonicCustomMod.Zip.ZipFile.DefaultEncoding;
                    AlternateEncodingUsage = ZipOption.Never;
                }
            }
        }
        ...
        private static ZipEntry Create(string nameInArchive, ZipEntrySource source, Object arg1, Object arg2)
        {
            if (String.IsNullOrEmpty(nameInArchive))
                throw new IonicCustomMod.Zip.ZipException("The entry name must be non-null and non-empty.");
            ...
            else
            {
                ...
                if (String.IsNullOrEmpty(filename))
                    throw new IonicCustomMod.Zip.ZipException("The filename must be non-null and non-empty.");
        ...
        private IonicCustomMod.Zlib.CompressionLevel _CompressionLevel;
        ...
        internal UInt32 _Key1;
        internal UInt32 _Key2;
        internal UInt32 _Key3;
