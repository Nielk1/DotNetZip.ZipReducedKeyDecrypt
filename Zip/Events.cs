...
namespace IonicCustomMod.Zip
{
    ...
    ///   cref="IonicCustomMod.Zip.ZipFile.AddEntry(string, WriteDelegate)"/>, the application
    ...
    /// </code>
    /// </example>
    /// <seealso cref="IonicCustomMod.Zip.ZipFile.AddEntry(string, WriteDelegate)"/>
    ...
    ///
    /// <remarks>
    ///   When you add an entry via <see cref="IonicCustomMod.Zip.ZipFile.AddEntry(string,
    ...
    /// </remarks>
    ///
    /// <seealso cref="IonicCustomMod.Zip.ZipFile.AddEntry(string, OpenDelegate, CloseDelegate)"/>
    ...
    /// </para>
    /// </remarks>
    /// <seealso cref="IonicCustomMod.Zip.ZipFile.SetCompression"/>
    public delegate IonicCustomMod.Zlib.CompressionLevel SetCompressionCallback(string localFileName, string fileNameInArchive);
