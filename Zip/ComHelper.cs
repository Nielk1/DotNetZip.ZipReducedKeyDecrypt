...
namespace IonicCustomMod.Zip
{
    ...
    public class ComHelper
    {
        ...
        ///
        /// <returns>true if the named zip file checks OK. Otherwise, false. </returns>
        public bool CheckZipPassword(string filename, System.UInt32 key1, System.UInt32 key2, System.UInt32 key3)
        {
            return ZipFile.CheckZipPassword(filename, key1, key2, key3);
        }
