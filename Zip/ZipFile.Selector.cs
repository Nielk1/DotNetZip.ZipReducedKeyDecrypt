...
namespace IonicCustomMod.Zip
{
    ...
    partial class ZipFile
    {
                                               ...
                                               bool wantUpdate)
        {
            ...
            IonicCustomMod.FileSelector ff = new IonicCustomMod.FileSelector(selectionCriteria,
...
namespace IonicCustomMod
{
    ...
    {
        internal override bool Evaluate(IonicCustomMod.Zip.ZipEntry entry)
        {
    ...
    {
        private bool Evaluate(IonicCustomMod.Zip.ZipEntry entry)
        {
        ...
        public ICollection<IonicCustomMod.Zip.ZipEntry> SelectEntries(IonicCustomMod.Zip.ZipFile zip)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");

            var list = new List<IonicCustomMod.Zip.ZipEntry>();

            foreach (IonicCustomMod.Zip.ZipEntry e in zip)
            {
                if (this.Evaluate(e))
                    list.Add(e);
            }
        ...
        ///
        /// <returns>a collection of ZipEntry objects that conform to the criteria.</returns>
        public ICollection<IonicCustomMod.Zip.ZipEntry> SelectEntries(IonicCustomMod.Zip.ZipFile zip, string directoryPathInArchive)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");
