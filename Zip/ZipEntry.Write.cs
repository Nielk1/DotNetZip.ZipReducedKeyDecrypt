...
namespace IonicCustomMod.Zip
{
    public partial class ZipEntry
    {
...
#if BZIP
            if (this.CompressionMethod == IonicCustomMod.Zip.CompressionMethod.BZip2)
        ...
        private bool WantReadAgain()
        {
            ...
            if (CompressionLevel == IonicCustomMod.Zlib.CompressionLevel.None) return false;
        ...
        private void MaybeUnsetCompressionMethodForWriting(int cycle)
        {
            ...
            if (CompressionLevel == (short)IonicCustomMod.Zlib.CompressionLevel.None &&
                CompressionMethod == IonicCustomMod.Zip.CompressionMethod.Deflate)
                _CompressionMethod = 0x00;
        ...
        internal void WriteHeader(Stream s, int cycle)
        {
            ...
            // LastMod
            _TimeBlob = IonicCustomMod.Zip.SharedUtilities.DateTimeToPacked(LastModified);
        ...
        private Int32 FigureCrc32()
        {
            if (_crcCalculated == false)
            {
                ...
                {
                    var output = new IonicCustomMod.Crc.CrcCalculatorStream(Stream.Null);
                ...
                else
                {
                    ...
                    var crc32 = new IonicCustomMod.Crc.CRC32();
        ...
        private void _WriteEntryData(Stream s)
        {
            ...
            try
            {
                ...
                var output = new IonicCustomMod.Crc.CrcCalculatorStream(compressor, true);
            ...
            else if (this._Source == ZipEntrySource.ZipFile)
            {
                ...
                if ((_Encryption_FromZipFile == EncryptionAlgorithm.None))
                {
                    ...
                    if (key1 == 0 && key2 == 0 && key3 == 0)
                    {
                        ...
                        key2 = this._container._Key1;
                        key3 = this._container._Key1;
                    }
                }
                this._sourceStream = InternalOpenReader(key1, key2, key3);
                PrepSourceStream();
                input = this._sourceStream;
        ...
        internal void FinishOutputStream(Stream s,
                                         ...
                                         Stream encryptor,
                                         Stream compressor,
                                         IonicCustomMod.Crc.CrcCalculatorStream output)
        {
            ...
            if ((compressor as IonicCustomMod.Zlib.DeflateStream) != null)
                compressor.Close();
#if BZIP
            else if ((compressor as IonicCustomMod.BZip2.BZip2OutputStream) != null)
                compressor.Close();
#if !NETCF
            else if ((compressor as IonicCustomMod.BZip2.ParallelBZip2OutputStream) != null)
                compressor.Close();
#endif
#endif

#if !NETCF
            else if ((compressor as IonicCustomMod.Zlib.ParallelDeflateOutputStream) != null)
                compressor.Close();
#endif
            ...
            if (_UncompressedSize == 0 && _CompressedSize == 0)
            {
                ...
                if (_Key1 > 0 || _Key2 > 0 || _Key3 > 0)
                {
                    ...
                    if (Encryption != EncryptionAlgorithm.None)
                    {
                        ...
                        // workitem 10178
                        IonicCustomMod.Zip.SharedUtilities.Workaround_Ladybug318918(s);
        ...
        internal void PrepOutputStream(Stream s,
                                       ...
                                       out IonicCustomMod.Crc.CrcCalculatorStream output)
        {
            ...
            // Wrap a CrcCalculatorStream around that.
            // This will happen BEFORE compression (if any) as we write data out.
            output = new IonicCustomMod.Crc.CrcCalculatorStream(compressor, true);
        }
        ...
        {
            if (_CompressionMethod == 0x08 && CompressionLevel != IonicCustomMod.Zlib.CompressionLevel.None)
            {
#if !NETCF
                     ...
                     _container.ParallelDeflateThreshold > 0L))
                {
                    ...
                    if (_container.ParallelDeflater == null)
                    {
                        _container.ParallelDeflater =
                            new IonicCustomMod.Zlib.ParallelDeflateOutputStream(s,
                                                                       CompressionLevel,
                                                                       _container.Strategy,
                                                                       true);
                    ...
                    IonicCustomMod.Zlib.ParallelDeflateOutputStream o1 = _container.ParallelDeflater;
                    o1.Reset(s);
                    return o1;
                }
#endif
                var o = new IonicCustomMod.Zlib.DeflateStream(s, IonicCustomMod.Zlib.CompressionMode.Compress,
                                                     CompressionLevel,
                                                     true);
                if (_container.CodecBufferSize > 0)
            ...
            if (_CompressionMethod == 0x0c)
            {
                     ...
                     _container.ParallelDeflateThreshold > 0L))
                {
                    ...
                    var o1 = new IonicCustomMod.BZip2.ParallelBZip2OutputStream(s, true);
                    return o1;
                }
#endif
                var o = new IonicCustomMod.BZip2.BZip2OutputStream(s, true);
                return o;
            }
#endif
        ...
        internal void WriteSecurityMetadata(Stream outstream)
        {
            ...
            UInt32 key1 = this._Key1;
            UInt32 key2 = this._Key2;
            UInt32 key3 = this._Key3;
            ...
            if (this._Source == ZipEntrySource.ZipFile && key1 == 0 && key2 == 0 && key3 == 0)
            {
            ...
            TraceWriteLine("WriteSecurityMetadata: e({0}) crypto({1}) pw({2})",
                           FileName, Encryption.ToString(), key1, key2, key3);
            ...
            if (Encryption == EncryptionAlgorithm.PkzipWeak)
            {
                ...
                _zipCrypto_forWrite = ZipCrypto.ForWrite(key1, key2, key3);
