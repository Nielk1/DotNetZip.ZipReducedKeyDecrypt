...
namespace  IonicCustomMod.Zip
{
    ...
    public class ZipInputStream : Stream
    {
        ...
        private void SetupStream()
        {
            ...
            _crcStream= _currentEntry.InternalOpenReader(_Key1, _Key2, _Key3);
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            if (_LeftToRead == 0)
            {
                ...
                // workitem 10178
                IonicCustomMod.Zip.SharedUtilities.Workaround_Ladybug318918(_inputStream);
            }
        ...
        private IonicCustomMod.Crc.CrcCalculatorStream _crcStream;
