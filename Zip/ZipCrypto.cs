...
namespace IonicCustomMod.Zip
{
    ...
    internal class ZipCrypto
    {
        ...
        public static ZipCrypto ForWrite(UInt32 key1, UInt32 key2, UInt32 key3)
        {
            ZipCrypto z = new ZipCrypto();
            //if (password == null)
            //    throw new BadPasswordException("This entry requires a password.");
            z.InitCipher(key1, key2, key3);
            return z;
        }


        public static ZipCrypto ForRead(UInt32 key1, UInt32 key2, UInt32 key3, ZipEntry e)
        {
        ...
        ///
        /// </remarks>
        public void InitCipher(UInt32 key1, UInt32 key2, UInt32 key3)
        {
        ...
        private IonicCustomMod.Crc.CRC32 crc32 = new IonicCustomMod.Crc.CRC32();
